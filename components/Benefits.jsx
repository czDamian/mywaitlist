...
const Benefits = () => {
  ...
  return (
    <section className="my-20 xl:my-40 mx-3 md:mx-8 xl:mx-16 p-4 bg-zinc-700 rounded-lg">
      <div>
      ...
      <div className="  grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5  ">
        {items.map((item) => (
          <div
            key={item.id}
            className="bg-zinc-800 p-4 xl:p-8 rounded-md lg:rounded-xl">
            <div className="font-extrabold text-white text-xl"> {item.name} </div>
